    ...
    <div class="form--steps-container">
        ...
        <form:form method="post" modelAttribute="donation">
            ...
            <div data-step="3">
                ...
                <c:forEach items="${institutions}" var="institution" begin="0" end="0">
                    <div class="form-group form-group--checkbox">
                        <label>
                            <form:radiobutton path="institution.id" value="${institution.id}" data-name="${institution.name}" checked="true" />
                ...
                <c:forEach items="${institutions}" var="institution" begin="1" end="${institutions.size()}">
                    <div class="form-group form-group--checkbox">
                        <label>
                            <form:radiobutton path="institution.id" data-name="${institution.name}" value="${institution.id}" />
                            <span class="checkbox radio"></span>
                            <span class="description">
                      <div class="title">${institution.name}</div>
                      <div class="subtitle">
