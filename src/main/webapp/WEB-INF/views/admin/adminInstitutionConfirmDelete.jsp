...
<head>
    ...
    <title>Usuń Instytucję | Charity</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Usuwanie instytucji!</h1>
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-2 mb-3 mb-sm-0">
                                                <a href="/admin/institution/delete/${institution.id}" class="cancelCustom">
